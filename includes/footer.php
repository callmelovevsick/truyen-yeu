        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div class="footer-section bg-gray-700 p-5 rounded-lg shadow-lg border border-gray-600 hover:-translate-y-1 hover:shadow-xl transition">
                <a href="<?= $base_url; ?>" class="footer-logo">
                    <span class="logo-text text-3xl font-bold text-blue-500 uppercase tracking-wide hover:text-blue-400 transition">TruyenYeu</span>
                </a>
            ...
            <div class="footer-section bg-gray-700 p-5 rounded-lg shadow-lg border border-gray-600 hover:-translate-y-1 hover:shadow-xl transition">
                ...
                <p class="footer-info text-gray-300 text-sm mb-2">© 2025 TruyenYeu By Lovevsick - Ăn cắp sút vỡ alo</p>
